...
public class ArrayListTreeTest {
  ...
  @Test(dataProvider = "getTree")
  public void addEE(int testCaseNumber, ArrayListTree<String> tree) throws NodeNotFoundException {
	  int initialSize = tree.size();
	  if(initialSize == 0) {
  ...
  @Test(dataProvider = "getTree")
  public void addAllCollectionextendsE(int testCaseNumber, ArrayListTree<String> tree) {
	int initialSize = tree.size();
  ...
  @Test(dataProvider = "getTree")
  public void addAllECollectionextendsE(int testCaseNumber, ArrayListTree<String> tree) throws NodeNotFoundException {
	  int initialSize = tree.size();
	  if(initialSize > 0) {
  ...
  @Test(dataProvider = "getTree")
  public void children(int testCaseNumber, ArrayListTree<String> tree) throws NodeNotFoundException {
	  try {
		  tree.children(null);
  ...
  @Test(dataProvider = "getTree")
  public void clear(int testCaseNumber, ArrayListTree<String> tree) {
	tree.clear();
    Assert.assertEquals(0, tree.size());
  }

  @Test(dataProvider = "getTree")
  public void commonAncestor(int testCaseNumber, ArrayListTree<String> tree) throws NodeNotFoundException {
	for(String i: tree)
		for(String j: tree)
  ...
  @Test(dataProvider = "getTree")
  public void contains(int testCaseNumber, ArrayListTree<String> tree) {
  ...
  @Test(dataProvider = "getTree")
  public void depth(int testCaseNumber, ArrayListTree<String> tree) {
	  if(testCaseNumber == 0)
  ...
  @Test(dataProvider = "getTree")
  public void inOrderTraversal(int testCaseNumber, ArrayListTree<String> tree) {
	  /*arrayListTree.add("Root1");
		arrayListTree.add("Root1", "C1");
		arrayListTree.add("Root1", "C2");
		arrayListTree.add("C1", "C1-1");
  ...
  @Test(dataProvider = "getTree")
  public void isEmpty(int testCaseNumber, ArrayListTree<String> tree) {
	  switch(testCaseNumber) {
	  	case 0:
  ...
  @Test(dataProvider = "getTree")
  public void leaves(int testCaseNumber, ArrayListTree<String> tree) {
	  switch(testCaseNumber) {
	  	case 0:
  ...
  @Test(dataProvider = "getTree")
  public void levelOrderTraversal(int testCaseNumber, ArrayListTree<String> tree) {
	  switch(testCaseNumber) {
	  	case 0:
  ...
  @Test(dataProvider = "getTree")
  public void postOrderTraversal(int testCaseNumber, ArrayListTree<String> tree) {
	  switch(testCaseNumber) {
	  	case 0:
  ...
  @Test(dataProvider = "getTree")
  public void preOrderTraversal(int testCaseNumber, ArrayListTree<String> tree) {
	  switch(testCaseNumber) {
	  	case 0:
  ...
  @Test(dataProvider = "getTree")
  public void remove(int testCaseNumber, ArrayListTree<String> tree) {
	  switch(testCaseNumber) {
	  	case 0:
	  		try {
	  		  tree.remove(null);
  ...
  @Test(dataProvider = "getTree")
  public void removeAll(int testCaseNumber, ArrayListTree<String> tree) {
	  switch(testCaseNumber) {
	  	case 0:
	  		Assert.assertEquals(true, tree.preOrderTraversal().isEmpty());
	  		break;
  ...
  @Test(dataProvider = "getTree")
  public void retainAll(int testCaseNumber, ArrayListTree<String> tree) {
   try {
  ...
  @Test(dataProvider = "getTree")
  public void root(int testCaseNumber, ArrayListTree<String> tree) {
	  switch(testCaseNumber) {
	  	case 0:
  ...
  @Test(dataProvider = "getTree")
  public void siblings(int testCaseNumber, ArrayListTree<String> tree) throws NodeNotFoundException {
	  switch(testCaseNumber) {
	  	case 0:
	  		try {
	  		  tree.siblings(null);
  ...
  @Test(dataProvider = "getTree")
  public void size(int testCaseNumber, ArrayListTree<String> tree) {
	  switch(testCaseNumber) {
	  	case 0:
	  		Assert.assertEquals(0, tree.size());
	  		break;
  ...
  @Test(dataProvider = "getTree")
  public void toArray(int testCaseNumber, ArrayListTree<String> tree) {
	  switch(testCaseNumber) {
	  	case 0:
  ...
  @Test(dataProvider = "getTree")
  public void toArrayT(int testCaseNumber, ArrayListTree<String> tree) {
	  switch(testCaseNumber) {
	  	case 0:
  ...
  @Test(dataProvider = "getTree")
  public void equals(int testCaseNumber, ArrayListTree<String> tree) throws NodeNotFoundException {
	  switch(testCaseNumber) {
	  	case 0:
	  		ArrayListTree<String> arrayListTree = new ArrayListTree<String>();
